...
function Dashboard() {
    ...
    const [secondLastItem, setSecondLastItem] = useState(null);
    ...
    const fetchAdditionalData = () => {
        ...
        fetch(`${serverConfig.serverUrl}data/${id}/30`)
            ...
            .then(data => {
                ...
                setSecondLastItem(data[data.length - 2]);
    ...
    return (
        <>
            <div style={
                ...
                <div>
                    {loaderChart && <Loader/>}
                    {!loaderChart && <CurrentState data={lastItem} prevdata={secondLastItem}/>}
                </div>
                <div>
                    {loaderChart && <Loader/>}
